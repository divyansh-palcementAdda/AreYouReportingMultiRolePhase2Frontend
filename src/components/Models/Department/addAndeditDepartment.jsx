...
const AddAndEditDepartmentModal = ({ isOpen, onClose, departmentToEdit, onSuccess }) => {
  ...
  useEffect(() => {
    if (departmentToEdit) {
      setFormData({
        ...
        isActive: departmentToEdit.active !== undefined ? departmentToEdit.active : (departmentToEdit.isActive !== undefined ? departmentToEdit.isActive : true),
      });
    } else {
      setFormData({
        name: "",
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (departmentToEdit) {
        await updateDepartment(departmentToEdit.id, dataToSubmit);
        toast.success("Department updated successfully!");
      } else {
        await addDepartment(dataToSubmit);
